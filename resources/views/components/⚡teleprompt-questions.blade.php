...
<div class="relative">
    ...
    <div wire:click="next()" class="cursor-pointer h-screen w-screen flex items-center justify-center bg-black text-white font-medium text-[10vw]">
            ...
            @else
                ...
                @else
                    <div wire:transition class="text-center">
                        ...
                        <h1 class="leading-1">{{ $event->questions[$current - 1] }}</h1>
                    </div>
                @endif
            @endif
        </div>
